...
- 🕐 Фильтрация по времени получения кода (10 мин / час / день / неделя / месяц / свой период)
...
3. Введи название предмета в поле поиска

4. При необходимости выбери **период** в селекторе «Время создания:»:
   - Выбор «Свой период» открывает поле для ввода произвольного количества минут

5. Нажми **Найти** или `Enter`

6. Дождись загрузки — скрипт автоматически обойдёт все страницы результатов

7. Нажми **📋 Копировать** — все коды скопируются в буфер обмена
...
- 🕐 Filter by code issue time (10 min / hour / day / week / month / custom)
...
3. Enter the item name in the search field

4. Optionally, select a **time period** from the «Period:» dropdown:
   - Selecting «Custom» reveals a field to enter an arbitrary number of minutes

5. Press **Search** or `Enter`

6. Wait for loading — the script will automatically go through all result pages

7. Click **📋 Copy** — all codes will be copied to your clipboard
